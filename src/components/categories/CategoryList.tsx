  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-lg md:text-xl xl:text-2xl font-montserrat font-semibold">Categories</h2>
          <div className="text-[9px] md:text-sm text-gray-500">Daftar Kategori dan Aturan Poin</div>
        </div>
        <div>
          <button onClick={handleAdd} className="px-2 py-1.5 md:px-3 md:py-2 bg-[#2563EB] text-white rounded-sm md:rounded-md text-[9px] md:text-sm">Add Category</button>
        </div>
      </div>
      ...
      <section className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base md:text-lg font-semibold">Furniture</h3>
          <div className="text-xs md:text-sm text-gray-500">{furniture.length} item(s)</div>
        </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base md:text-lg font-semibold">Material</h3>
          <div className="text-xs md:text-sm text-gray-500">{material.length} item(s)</div>
        </div>
